# Generated by Django 4.1.7 on 2024-05-19 16:01
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Courrier', models.IntegerField(default=-1)),
                ...
                ('dateHebergement', models.IntegerField()),
                ('DateEntree', models.DateField(db_column='dateEntree')),
                ('DateSortie', models.DateField(db_column='dateSorti')),
                ('ChambreDisponible', models.CharField(db_collation='utf8mb4_0900_ai_ci', db_column='chambreDispo', max_length=45)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dateSortie', models.DateField(db_column='dateSorti')),
                ('nomSalleDisponible', models.CharField(db_collation='utf8mb4_0900_ai_ci', db_column='nomSalledispo', max_length=45)),
                ...
                ('idsalle', models.ForeignKey(db_column='idsalle', on_delete=django.db.models.deletion.DO_NOTHING, to='guesthouse.salle')),
            ],
        ),
    ]
